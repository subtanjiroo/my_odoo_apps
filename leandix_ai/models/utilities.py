...
def get_error_message(status_code: int, lang_code: str = 'en_US') -> str:
    ...
    ERROR_MESSAGES = {
        401: {
            'vi_VN': 'API key không hợp lệ hoặc chưa có, hãy nhập lại API key ở <a href="/odoo/settings#leandix_ai" style="color: #0084ff;">Cài Đặt</a> hoặc liên hệ với <a href="https://leandix.com" style="color: #0084ff;">ADMIN</a> để được hỗ trợ.',
            'en_US': 'The API key is invalid or missing. Please enter it again in the <a href="/odoo/settings#leandix_ai" style="color: #0084ff;">Settings</a> or contact <a href="https://leandix.com" style="color: #0084ff;">ADMIN</a> for support.'
        },
        422: {
            'vi_VN': 'API key không hợp lệ hoặc chưa có, hãy nhập lại API key ở <a href="/odoo/settings#leandix_ai" style="color: #0084ff;">Cài Đặt</a> hoặc liên hệ với <a href="https://leandix.com" style="color: #0084ff;">ADMIN</a> để được hỗ trợ.',
            'en_US': 'The API key is invalid or missing. Please enter it again in the <a href="/odoo/settings#leandix_ai" style="color: #0084ff;">Settings</a> or contact <a href="https://leandix.com" style="color: #0084ff;">ADMIN</a> for support.'
